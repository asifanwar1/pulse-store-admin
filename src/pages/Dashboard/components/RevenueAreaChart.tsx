        ...
        <div className="bg-white border border-dash-card-border rounded-xl shadow-dash-card-hover px-3.5 py-2.5 text-xs">
            ...
            {payload.map((entry) => (
                <div key={entry.name} className="flex items-center gap-2 py-0.5">
                    ...
                    />
                    <span className="text-app-secondary capitalize">{entry.name}:</span>
    ...
    return (
        ...
        >
            <ResponsiveContainer width="100%" height={280}>
                <AreaChart data={monthlyRevenueData} margin={{ top: 4, right: 4, left: -16, bottom: 0 }}>
                    <defs>
                        <linearGradient id="gradRevenue" x1="0" y1="0" x2="0" y2="1">
                            <stop offset="5%" stopColor="#2A5C42" stopOpacity={0.18} />
                            <stop offset="95%" stopColor="#2A5C42" stopOpacity={0.01} />
                        </linearGradient>
