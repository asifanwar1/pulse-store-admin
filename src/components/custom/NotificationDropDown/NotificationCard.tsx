...
//     if (
//         projectType === PROJECT_TYPE.REIMAGINE ||
//         projectType === PROJECT_TYPE.POPULAR
//     ) {
//         return getParamsAttachedRoute(APP_ROUTES.PROJECT_MANAGEMENT_DETAILS, {
//             id: projectId,
//         });
//     } else {
//         return getParamsAttachedRoute(
//             APP_ROUTES.RENOVATION_MANAGEMENT_DETAILS,
//             {
//                 id: projectId,
//             },
//         );
        ...
        const onNotificationClick = (entityType: NotificationEntityType) => {
            ...
            switch (entityType) {
                ...
                case NotificationEntityType.ExperienceUpdated:
                    return navigate(
                        getParamsAttachedRoute(APP_ROUTES.DASHBOARD, {
                            id: installerId as number,
                        }),
                    );
                case NotificationEntityType.CertificationUpdated:
                    return navigate(
                        getParamsAttachedRoute(APP_ROUTES.ACCOUNT, {
                            id: installerId as number,
                        }),
                    );
                case NotificationEntityType.QuoteAccepted:
                    return navigate(
                        getParamsAttachedRoute(
                            APP_ROUTES.ACCOUNT_CHANGE_PASSWORD,
                            {
                                id: projectId!,
                            },
                        ),
                ...
                case NotificationEntityType.QuoteRejected:
                    return navigate(
                        getParamsAttachedRoute(APP_ROUTES.ACCOUNT_PROFILE, {
                            id: projectId!,
                        }),
                    );
                default:
            ...
            <div
                ...
                onClick={() =>
                    handleNotificationClick(
                        notification?.type as NotificationEntityType,
                    )
                }
            >
